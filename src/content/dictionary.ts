...
const es: Dictionary = {
  ...
  about: {
    ...
    facts: [
      ...
      "Gestioné capital propio y de un cliente con el mismo proceso de validación de riesgo",
...
const en: Dictionary = {
  ...
  about: {
    ...
    facts: [
      ...
      "Managed my own and a client's capital with the same risk-validation process",
