...
export default function SiteFooter({ locale }: { locale: Locale }) {
  ...
  return (
    <footer className="rule-t overflow-hidden px-6 pb-8 pt-16 md:px-10 md:pt-24">
      <div className="footer-mark pointer-events-none whitespace-nowrap select-none text-[19vw] font-medium leading-[0.8] tracking-[-0.04em] text-foreground/[0.06] md:text-[15vw]">
        {t.name}
      </div>
